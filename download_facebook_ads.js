...
function isReqData(req, query) {
	...
	// 	q=umbria&session_id=f2371099-6n22-4776-6gb2-632w3q541705&count=30&active_status=all
...
(async () => {
	...
	let activeStatusRequest = 'all',
		...
		//gotoUrl = 'https://www.facebook.com/ads/library/' + 
		//	'?active_status=' + activeStatusRequest + '&ad_type=political_and_issue_ads&country=IT&q=' + query,
		//fbAdsReqUrlOld = 'https://www.facebook.com/ads/library/async/search_ads/' + 
		//	'?q=' + query + '&count=30&active_status=' + activeStatusRequest + '&category=1&countries[0]=IT',
		//fbAdsReqUrlNew = 'https://www.facebook.com/ads/library/async/search_ads/' + 
		//	'?q=' + query + '&count=' + num + '&active_status=' + activeStatusRequest + '&category=1&countries[0]=IT';
		//fbAdsReqUrlOld = 'https://www.facebook.com/ads/library/async/search_ads/' + 
		//	'?q=' + query + '&count=30&active_status=' + activeStatusRequest + '&category=1&countries[0]=IT',
		//fbAdsReqUrlNew = 'https://www.facebook.com/ads/library/async/search_ads/' + 
		//	'?q=' + query + '&count=' + num + '&active_status=' + activeStatusRequest + '&category=1&countries[0]=IT';
		//fbAdsReqUrlOld = 'https://www.facebook.com/ads/library/async/search_ads/' + 
		//	'?q=' + query + '&count=30&active_status=' + activeStatusRequest + '&ad_type=political_and_issue_ads&countries[0]=IT',
		//fbAdsReqUrlNew = 'https://www.facebook.com/ads/library/async/search_ads/' + 
		//	'?q=' + query + '&count=' + num + '&active_status=' + activeStatusRequest +
		//	'&ad_type=political_and_issue_ads&countries[0]=IT';			

		fbAdsReqUrlOld = '';

		//fbAdsReqUrlNewForward = 'https://www.facebook.com/ads/library/async/search_ads/' + 
		//	'?q=' + query + '&forward_cursor={forwardCursor}&count=30&active_status=' + 
		//	activeStatusRequest + '&category=1&countries[0]=IT',
		//fbAdsReqUrlNewForwardBackward = 'https://www.facebook.com/ads/library/async/search_ads/' + 
		//	'?q=' + query + '&forward_cursor={forwardCursor}&backward_cursor={backwardCursor}&count=30&active_status=' + 
		//	activeStatusRequest + '&category=1&countries[0]=IT';
	...
	// Screenshot per eventuale debug
	await page.screenshot({'path': 'fb_ads_screenshot_1.png', fullPage: true});
	await browser.close();
